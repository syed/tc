...
class DiskSpaceTest {
	...
	static void assertEquals(int testCase, const int& expected,
			const int& actual) {
		if (expected == actual) {
	...
	void testCase0() {
		...
		vector<int> total(total_,
				total_ + (sizeof(total_) / sizeof(total_[0])));
		int expected_ = 2;
	...
	void testCase3() {
		int used_[] = { 49, 49, 49, 49, 49, 49, 49, 49, 49, 49, 49, 49, 49, 49,
				49, 49, 49, 49, 49, 49, 49, 49, 49, 49, 49, 49, 49, 49, 49, 49,
				49, 49, 49, 49, 49, 49, 49, 49, 49, 49, 49, 49, 49, 49, 49, 49,
				49, 49, 49, 49 };
		vector<int> used(used_, used_ + (sizeof(used_) / sizeof(used_[0])));
		int total_[] = { 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50, 50,
	...
	void testCase4() {
		int used_[] = { 331, 242, 384, 366, 428, 114, 145, 89, 381, 170, 329,
				190, 482, 246, 2, 38, 220, 290, 402, 385 };
		vector<int> used(used_, used_ + (sizeof(used_) / sizeof(used_[0])));
		int total_[] = { 992, 509, 997, 946, 976, 873, 771, 565, 693, 714, 755,
				878, 897, 789, 969, 727, 765, 521, 961, 906 };
		vector<int> total(total_,
				total_ + (sizeof(total_) / sizeof(total_[0])));
		int expected_ = 6;
...
public:
	void runTest(int testCase) {
		...
		case (4):
			...
			break;
		default:
			cerr << "No such test case: " << testCase << endl;
			break;
		}
	}
